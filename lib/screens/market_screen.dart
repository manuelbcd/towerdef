            ...
            children: [
              ...
              Expanded(
                child: ListView(
                  children: [
                    ...availableTowers
                        .map((tower) => _ShopCard(item: tower, onBuy: () {})),
                    const SizedBox(height: 18),
                    ...availableUpgrades.map(
                        (upgrade) => _UpgradeCard(item: upgrade, onBuy: () {})),
                  ],
                ),
              ),
            ],
...
class _Header extends StatelessWidget {
  ...
  const _Header({Key? key, required this.title, required this.onBack})
      : super(key: key);
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(item.nameKey.t(context),
                    style: context.theme.textTheme.titleMedium?.copyWith(
                        color: Colors.white, fontWeight: FontWeight.w600)),
                const SizedBox(height: 6),
                Text(item.descriptionKey.t(context),
...
class _UpgradeCard extends StatelessWidget {
  ...
  const _UpgradeCard({Key? key, required this.item, required this.onBuy})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(item.titleKey.t(context),
                    style: context.theme.textTheme.titleMedium?.copyWith(
                        color: Colors.white, fontWeight: FontWeight.w600)),
              ),
              Text('${item.price} ₡',
          ...
          Text(item.subtitleKey.t(context),
              style: context.theme.textTheme.bodyMedium
                  ?.copyWith(color: Colors.white70)),
